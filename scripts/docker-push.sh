...
IMAGE_TAG_EDGE="${SOFTWARE_VERSION}-edge"
IMAGE_TAG_STABLE="${SOFTWARE_VERSION}"
IMAGE_TAG_RELEASE_MAJOR="${SOFTWARE_VERSION}-${VERSION_MAJOR}"
IMAGE_TAG_RELEASE_MAJOR_MINOR="${SOFTWARE_VERSION}-${VERSION_MAJOR}.${VERSION_MINOR}"
